package com.kochava.kochava_measurement
...
/**
 * Kochava Measurement Plugin
 */
class KochavaMeasurementPlugin : FlutterPlugin, MethodCallHandler {
    private val LOGTAG = "KVA/Measurement"
    ...
    override fun onAttachedToEngine(flutterPluginBinding: FlutterPlugin.FlutterPluginBinding) {
        ...
        channel = MethodChannel(flutterPluginBinding.binaryMessenger, "kochava_measurement")
        ...
        val isFailure = runCatching {
            return when (call.method) {
                ...
                "registerDeeplinkWrapperDomain" -> {
                    val domain = call.arguments() ?: ""
                    Tracker.getInstance().registerDeeplinkWrapperDomain(domain);
                    result.success(null)
                }
